...
public class ImageLoader {
    ...
    /**
     * The cache implementation to be used as an L1 cache before calling into react.
     */
    ...
    /**
     * Wrapper class used to metaList a Request to the set of active ImageContainer objects that are
